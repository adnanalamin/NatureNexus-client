...
const TouristStoryCard = ({ data }) => {
  const { _id, tourDetails, userPhoto, rating, userName } = data;
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 items-center gap-8 max-w-4xl">
              <div className="mx-auto">
                <img
                  src={userPhoto}
                  className="w-[280px] h-96 rounded-lg shadow-[-20px_20px_0px_rgba(23,219,220,1)]"
                />
              </div>
              <div>
                <svg
