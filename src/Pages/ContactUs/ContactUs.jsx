          ...
          <div className="grid lg:grid-cols-2 items-start gap-16">
            <form>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full bg-gray-100 rounded py-3 px-6 text-sm focus:outline-blue-600"
                />
                <input
                  type="email"
                  placeholder="Email"
                ...
                <textarea
                  placeholder="Message"
                  rows="6"
                  className="w-full bg-gray-100 rounded px-6 text-sm pt-3 focus:outline-blue-600"
                ></textarea>
                <button
                  type="button"
                  className="text-white bg-blue-600 hover:bg-blue-700 font-semibold rounded text-sm px-6 py-3"
                >
                  <svg
            ...
            <div className="grid sm:grid-cols-2  gap-16">
              <div className="flex items-start bg-white">
                ...
                <div className="ml-6">
                  <h4 className="text-[#333] text-base font-extrabold">
                    Visit office
                  </h4>
              ...
              <div className="flex items-start bg-white">
                ...
                <div className="ml-6">
                  <h4 className="text-[#333] text-base font-extrabold">Fax</h4>
                  <p className="text-sm tect-gray-400 mt-2">+880 41 867</p>
                </div>
              </div>
            </div>
          </div>
